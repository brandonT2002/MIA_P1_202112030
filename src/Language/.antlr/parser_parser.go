...
func parserParserInit() {
	...
	staticData.SymbolicNames = []string{
		...
		"RW_fit", "RW_unit", "RW_driveletter", "RW_name", "RW_type", "RW_delete",
		"RW_add", "RW_id", "RW_fs", "RW_user", "RW_pass", "RW_grp", "RW_path",
		"RW_r", "RW_cont", "RW_fileN", "RW_destino", "RW_ugo", "RW_ruta", "TK_fit",
		"TK_unit", "TK_type", "TK_fs", "TK_number", "TK_path", "TK_equ", "TK_sym",
		"COMMENTARY",
	}
	...
	staticData.serializedATN = []int32{
		4, 1, 70, 39, 2, 0, 7, 0, 2, 1, 7, 1, 2, 2, 7, 2, 2, 3, 7, 3, 1, 0, 1,
		...
		6, 2, -1, 0, 28, 5, 1, 0, 0, 0, 29, 34, 5, 28, 0, 0, 30, 31, 5, 55, 0,
...
const (
	...
	ParserParserRW_fit         = 43
	ParserParserRW_unit        = 44
	ParserParserRW_driveletter = 45
	...
	ParserParserRW_path        = 55
	ParserParserRW_r           = 56
	ParserParserRW_cont        = 57
	ParserParserRW_fileN       = 58
	ParserParserRW_destino     = 59
	ParserParserRW_ugo         = 60
	ParserParserRW_ruta        = 61
	ParserParserTK_fit         = 62
	ParserParserTK_unit        = 63
	ParserParserTK_type        = 64
	ParserParserTK_fs          = 65
	ParserParserTK_number      = 66
	ParserParserTK_path        = 67
	ParserParserTK_equ         = 68
	ParserParserTK_sym         = 69
	ParserParserCOMMENTARY     = 70
)
